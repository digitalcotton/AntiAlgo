...
export const ROUTES = [
  ...
  { key: 'ledger', pattern: '/ledger', kind: 'static', note: 'The Ledger: a paid, behind-login read of the market against the titles you watch, counted from last night, sweep stamp on every number.', sitemap: false },
